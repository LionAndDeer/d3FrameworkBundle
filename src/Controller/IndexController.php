...
use Liondeer\Model\AbstractConfigFeatureHeadlineModel;
...
class IndexController extends AbstractController
{
    ...
    public function __construct(
        ...
        $this->dmsObjectExtensionControllers = $controllerRegistrator->getAbstractDmsObjectExtensionControllers();
    }
